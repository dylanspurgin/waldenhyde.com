...
#-----------------------------------------------------------------#
add_action( 'after_setup_theme', 'salient_second_child_portfolio_meta_override', 0 );

function salient_second_child_portfolio_meta_override () {
    remove_action('add_meta_boxes', 'nectar_metabox_portfolio');
    add_action('add_meta_boxes', 'nectar_metabox_portfolio_salient_second_child');
}

function nectar_metabox_portfolio_salient_second_child(){
	...
	//wp 3.6+
		...
		$meta_box = array(
			...
			'fields' => array(
                ...
                array(
					'name' => __('Project Subtitle', NECTAR_THEME_NAME),
					'desc' => __('Displayed at top of portfolio pages on the left hand side.', NECTAR_THEME_NAME),
					'id' => '_nectar_portfolio_item_subtitle',
					'type' => 'text',
					'std' => ''
				),
                array(
